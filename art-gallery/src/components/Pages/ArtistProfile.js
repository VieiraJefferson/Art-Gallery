    ...
    <div className="artist-container">
      <div className="artist-header">
        <div className="artist-content">
          ...
          {/* Container 1: Texto à esquerda, ícone à direita */}
            ...
            <div className="text-block">
              <div className="text-content">
                ...
                <p>
                  ...
                  of solitude, love, identity, and the passage of time, creating
                  a visual dialogue that resonates on multiple levels.
                </p>
                <p>
                  A hallmark of Maria Pallas’s work is the masterful use of
                  color and composition. Whether through bold, striking palettes
                  or subdued monochrome tones, each choice is intentional,
                  amplifying the atmosphere and emotions within the scene.
                </p>
                <p>
            ...
            <div className="text-block reverse">
              <div className="text-content">
                <p>
                  ...
                  language. Recurring motifs such as tigers, birds, and
                  enigmatic objects serve as metaphors, reflecting themes of
                  power, vulnerability, transformation, or the subconscious
                  mind.
                </p>
                <p>
                ...
                <p>
                  ...
                  viewers to pause, question, and connect with their own
                ...
                <p>
                  ...
                  where meaning is fluid, and each observer is free to find
                  their own truth within the imagery.
